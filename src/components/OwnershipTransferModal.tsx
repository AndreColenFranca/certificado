...
export const OwnershipTransferModal: React.FC<OwnershipTransferModalProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (typeof newOwnerName !== 'string' || !newOwnerName.trim()) return;

    onTransferOwner(
      cert.id,
      newOwnerName.trim(),
      typeof newOwnerCpf === 'string' ? newOwnerCpf.trim() || undefined : undefined,
      typeof newOwnerEmail === 'string' ? newOwnerEmail.trim() || undefined : undefined,
